...
<div class="container mt-5">
    <div class="row">
        ...
        <h4>R$<?php echo $produtos['Preco']?></h4>
                ...
                <p><img class="payment__img" src="./content/pix1.png"><a href="pix.php"> Pagar via Pix</a><img class="payment__img" src="./content/cartao1.png"><a href="cartao.php"> Pagar via Cartão</a><img class="payment__img" src="./content/boleto1.png"><a href="boleto.php"> Pagar via Boleto Bancário</a></p>
